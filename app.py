...
def nature():
	int_feature = [1,2,2,1,2,1,2,2,1,1]
	print(int_feature)
	int_feature = [float(i) for i in int_feature]
	final_features = [np.array(int_feature)]
	prediction = sf.predict(final_features)
	...
	if output == "0":
		return render_template('nature.html', prediction_text= 'Good')
	elif output == "1" :
		return render_template('nature.html', prediction_text= 'Average Work Hard')

	else  :
		return render_template('nature.html', prediction_text= 'Bad Hard Work Required')
...
def predict():
	if request.method == "POST":
		...
		if output == "0":
			return render_template('prediction.html', prediction_text= 'You can go for Engineer ')
		elif output == "1" :
			return render_template('prediction.html', prediction_text= 'You can go for Medical')

		else  :
			return render_template('prediction.html', prediction_text= 'You can go for Military ')
